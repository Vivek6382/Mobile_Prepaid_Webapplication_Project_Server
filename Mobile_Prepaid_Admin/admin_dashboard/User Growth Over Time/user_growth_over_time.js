...
// Line Chart: User Growth Over Time (Last 12 Months)
...
const lineChart = new Chart(lineCtx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'User Growth Trend (Last 12 Months)', // Updated label
            data: [1200, 1500, 1800, 2000, 2500, 3000, 3500, 4200, 4800, 5200, 5800, 6500], // Example data (number of users)
